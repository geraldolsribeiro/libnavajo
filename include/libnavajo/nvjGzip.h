...
inline size_t
nvj_gzip( unsigned char **dst, const unsigned char *src, const size_t sizeSrc, bool rawDeflateData = false )
{
  z_stream strm;
...
inline size_t
nvj_gunzip( unsigned char **dst, const unsigned char *src, const size_t sizeSrc, bool rawDeflateData = false )
{
  z_stream strm;
  size_t   sizeDst = CHUNK;
  int      ret;
...
inline size_t nvj_gzip_websocket_v2(
    unsigned char **     dst,
...
inline size_t nvj_gunzip_websocket_v2(
    unsigned char **     dst,
    const unsigned char *src,
    size_t               sizeSrc,
    bool                 rawDeflateData = false,
